        ...
        (restart-case
            (flet ((execute-command ()
              ...
              (unwind-protect (execute-command)
                ;; The command may have set the frame's query I/O, in which case
                ;; the values of FRAME-QUERY-IO and INTERACTORP would be
                ;; outdated; the other stream variables could be outdated as
                ;; well, but they are not used after executing the command.
