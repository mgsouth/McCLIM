  ...
  ((:module "drawing"
   ...
   (:module "extended-output"
    ...
    :components ((:file "protocol")
                 ...
                 (:file "stream-output"    :depends-on ("protocol" "utilities" "views" "text-cursor"))
                 (:file "recording"        :depends-on ("protocol" "stream-output"))
                 (:file "text-formatting"  :depends-on ("protocol" "recording" "utilities"))
