  ...
  (:layouts
   (default
    (vertically (:equalize-width t)
      (labelling (:label "McCLIM Examples"
      ...
      (horizontally ()
        (labelling (:label "Demos")
          (vertically (:equalize-width t)
            ...
            +fill+))
        (labelling (:label "Sheets and input")
          (vertically (:equalize-width t)
        ...
        (labelling (:label "Formatting and Drawing")
          (vertically (:equalize-width t)
            ...
            (make-demo-button "Patterns and designs" 'clim-demo.patterns:pattern-design-test)
            (make-demo-button "Overlapping patterns" 'patterns-overlap)
            (make-demo-button "Patterns on the Text Line" 'wrfg-test)
        ...
        (labelling (:label "Various Tests")
          (vertically (:equalize-width t)
            ...
            (make-demo-button "Indirect gestures" 'clim-demo.indirect-gestures:the-game)
            (make-demo-button "Presentation translators" 'clim-demo.presentation-translators-test:presentation-translators-test)
            (make-demo-button "Drag and drop translator" 'drag-test)
            ...
            (make-demo-button "Coordinate swizzling" 'clim-demo.coord-swizzling:coordinate-swizzling)
            +fill+)))))))
